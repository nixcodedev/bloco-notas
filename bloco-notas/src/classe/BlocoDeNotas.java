...
public class BlocoDeNotas {
	...
	public static void main(String[] args) {
		frame = new JFrame("Notes by NixCodeDev");
		...
		/* Ações dos ítens dos Menus */
		novoItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int option = JOptionPane.showConfirmDialog(frame,
						"Deseja salvar o arquivo atual antes de criar um novo?", "Salvar",
		...
		abrirItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int option = JOptionPane.showConfirmDialog(frame,
						"Deseja salvar o arquivo atual antes de abrir um novo?", "Salvar",
						JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
